...
// 生成时间: 2017.04.14 时间 03:07:30 PM CST 
//
...
public class RhcdCapabilityResponseMessage {

	@XmlElement(name = "Pack", required = true)
	protected RhcdCapabilityResponseMessage.Pack pack;

	/**
	 * 获取pack属性的值。
	 *
	 * @return possible object is {@link RhcdCapabilityResponseMessage.Pack }
	 *
	 */
	public RhcdCapabilityResponseMessage.Pack getPack() {
		return pack;
	}
	 ...
	 *
	 * @param value
	 *            allowed object is {@link RhcdCapabilityResponseMessage.Pack }
	 *
	 */
	public void setPack(RhcdCapabilityResponseMessage.Pack value) {
		this.pack = value;
	}
	...
	public static class Pack {
		...
		protected RhcdCapabilityResponseMessage.Pack.PPVSPMessage ppvspMessage;
		 ...
		 *         {@link RhcdCapabilityResponseMessage.Pack.PPVSPMessage }
		 *
		 */
		public RhcdCapabilityResponseMessage.Pack.PPVSPMessage getPPVSPMessage() {
			return ppvspMessage;
		}
		 ...
		 *
		 */
		public void setPPVSPMessage(RhcdCapabilityResponseMessage.Pack.PPVSPMessage value) {
		...
		public static class PPVSPMessage {
			...
			protected RhcdCapabilityResponseMessage.Pack.PPVSPMessage.Params params;
			 ...
			 *
			 * @return possible object is
			 *         {@link RhcdCapabilityResponseMessage.Pack.PPVSPMessage.Params }
			 *
			 */
			public RhcdCapabilityResponseMessage.Pack.PPVSPMessage.Params getParams() {
				return params;
			}
			 ...
			 *
			 */
			public void setParams(RhcdCapabilityResponseMessage.Pack.PPVSPMessage.Params value) {
				this.params = value;
			}
